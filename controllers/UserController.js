...
const store = async (req, res) => {
  try {
    if (req.body && req.body.firebaseToken && req.body.firstName && req.body.lastName) {
      firebaseAuth()
...
module.exports = { index, auth, oldAuth, bookings, show, store, update, remove, rate, exportReport, search, scheduledTrips, rents, adminSearch }
